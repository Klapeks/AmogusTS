...
class MapBuilder {
    constructor() { }
    texture: Texture = undefined as any;
    setTexture(texture: Texture) {
        this.texture = texture;
        return this;
    }

    hitbox: { data: Uint8ClampedArray, width: number, height: number } = undefined as any;
    ...
    uppertexture: Texture = undefined as any;
...
class Map {
    private _b: MapBuilder = undefined as any;
    private _sprite: Sprite = undefined as any;
    private _uppersprite: Sprite = undefined as any;
