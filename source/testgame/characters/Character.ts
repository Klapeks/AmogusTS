...
class Character {
    ...
    setNickname(nickname: string | undefined, color = "white") {
        ...
        if (this._nicknameSprite) {
            ...
            Game.getScene().removeMiddleSprite(this._nicknameSprite);
        ...
        Game.getScene().addMiddleSprite(false, this._nicknameSprite);
        return this;
    }
    getNickname() {
    ...
    showRoleplate() {
        ...
        if (this._roleplateSprite.hidden) {
            ...
            Game.getScene().addMiddleSprite(false, this._roleplateSprite);
        }
    }
    hideRoleplate() {
        ...
        this._roleplateSprite.hidden = true;
        Game.getScene().removeMiddleSprite(this._roleplateSprite);
        return this;
    }
